                        ...
                        <div id="tab1" class="tab-pane tab1 in">
                            ...
                            <div class="form-item cf">
                                ...
                                <div class="controls">
                                    ...
                                    <div class="upload-img-box"><img src="<?php echo ($data["img"]); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-item cf">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="text time" name="end_time" value="<?php echo ($data["end_time"]); ?>"></div>
                                </div>
                                <div class="form-item cf">
                                    <label class="item-label">联系人电话</label>
                                    <div class="controls">
                                        <input type="text" class="text input-large" name="tel" value="<?php echo ($data["tel"]); ?>"></div>
                                </div>
                            </div>
                            <div class="form-item cf">
