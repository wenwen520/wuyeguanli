                        ...
                        <div id="tab1" class="tab-pane tab1 in">
                            ...
                            <div class="form-item cf">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="hidden" name="path" id="cover_id_path" value="<?php echo ($date["path"]); ?>"/>
                                    <div class="upload-img-box"><img src="<?php echo ($data["path"]); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-item cf">
                                    <label class="item-label">发布日期：</label>
                                    <div class="controls">
                                        <input type="text" class="text time" name="create_time" value="<?php echo ($data["create_time"]); ?>"></div>
                                </div>
                                <div class="form-item cf">
                                    <label class="item-label">截止日期：</label>
                                    <div class="controls">
                                        <input type="text" class="text time" name="deadline" value="<?php echo ($data["deadline"]); ?>"></div>
                                </div>
                            </div>
                            <div class="form-item cf">
