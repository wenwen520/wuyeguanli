...
<header class="jumbotron subhead" id="overview">
  <div class="container">
    <h2>用户注册</h2>
    <p><span><span class="pull-left"><span>已经有账号? <a href="<?php echo U('Wechat/login');?>">点此登录</a> </span> </span></p>
  </div>
</header>
...
<section>
	<div class="span12">
        <form class="login-form" action="/index.php?s=/Wechat/Wechat/register.html" method="post">
