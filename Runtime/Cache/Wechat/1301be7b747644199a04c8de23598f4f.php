        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src=<?php echo ($l["img"]); ?>>
                                <div class="caption">
                                    <h4><?php echo ($l["title"]); ?></h4>

                                    <p class="text-danger"><?php echo ($l["price"]); echo ($l['unit']==0?'元/月':'万元'); ?></p>
                                    <p><a  href="<?php echo U('rental_detail?id='.$l['id']);?>" class="btn btn-danger zushouBtn">详细信息</a></p>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($sale)): $i = 0; $__LIST__ = $sale;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src=<?php echo ($s["img"]); ?>>
                                <div class="caption">
                                    <h4><?php echo ($s["title"]); ?></h4>

                                    <p class="text-danger"><?php echo ($s["price"]); echo ($s['unit']==0?'元/月':'万元'); ?></p>
                                    <p><a  href="<?php echo U('rental_detail?id='.$s['id']);?>" class="btn btn-danger zushouBtn">详细信息</a></p>
                                </div>
                            </div>
                        </div><?php endforeach; endif; else: echo "" ;endif; ?>>
                    </div>
