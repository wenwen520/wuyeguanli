...
<div class="main">
    ...
    <div class="container">
        ...
        <form class="form-signin login-form" action="<?php echo U('Wechat/Wechat/login');?>" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <img class="verifyimg reloadverify" alt="点击切换" src="<?php echo U('Wechat/Wechat/verify');?>" style="cursor:pointer;">
                </div>
        ...
        <p class="text-danger text-right"><a href="<?php echo U('Wechat/Wechat/register');?>">新用户注册</a></p>
    </div>
    <!-- /container -->
