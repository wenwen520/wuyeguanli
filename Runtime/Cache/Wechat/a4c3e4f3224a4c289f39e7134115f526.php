...
<nav class="navbar navbar-default navbar-fixed-bottom">
    <div class="container-fluid text-center">
        ...
        <div class="col-xs-3">
            <p class="navbar-text"><a href="<?php echo U('Member/my');?>">我的</a></p>
            <!--<a href="my.html" class="navbar-link">-->
        </div>
    </div>
</nav>
<!--导航结束-->
...
<div class="container-fluid">
    ...
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/notice');?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/rental');?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/community_activity');?>">
